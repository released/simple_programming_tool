...
#define M031_PIN_A(pin)        ((uint8_t)(0x00u | ((pin) & 0x0Fu)))
#define M031_PIN_B(pin)        ((uint8_t)(0x10u | ((pin) & 0x0Fu)))
#define M031_PIN_C(pin)        ((uint8_t)(0x20u | ((pin) & 0x0Fu)))
#define M031_PIN_F(pin)        ((uint8_t)(0x50u | ((pin) & 0x0Fu)))

#define M031_PIN_PORT(pin)     ((uint8_t)(((pin) >> 4) & 0x0Fu))
#define M031_PIN_INDEX(pin)    ((uint8_t)((pin) & 0x0Fu))

#define M031_BRIDGE_I2C_ROLE_NONE      0u
#define M031_BRIDGE_I2C_ROLE_MASTER    1u
#define M031_BRIDGE_I2C_ROLE_SLAVE     2u
...
typedef struct
{
    ...
    uint8_t addr7;
    uint32_t baudrate;
} M031_BRIDGE_I2C_STATE_T;

static M031_BRIDGE_I2C_STATE_T g_i2c_state[M031_BRIDGE_I2C_PORT_COUNT];
static uint8_t g_i2c_last_error = M031_BRIDGE_I2C_ERROR_NONE;
static volatile uint8_t g_i2c_slave_rx[M031_BRIDGE_I2C_PORT_COUNT][M031_BRIDGE_I2C_SLAVE_BUF_SIZE];
static volatile uint8_t g_i2c_slave_tx[M031_BRIDGE_I2C_PORT_COUNT][M031_BRIDGE_I2C_SLAVE_BUF_SIZE];
static volatile uint16_t g_i2c_slave_rx_len[M031_BRIDGE_I2C_PORT_COUNT];
static volatile uint16_t g_i2c_slave_tx_len[M031_BRIDGE_I2C_PORT_COUNT];
static volatile uint16_t g_i2c_slave_tx_index[M031_BRIDGE_I2C_PORT_COUNT];

static void BridgeI2c_ClearLastError(void)
{
    g_i2c_last_error = M031_BRIDGE_I2C_ERROR_NONE;
}

static void BridgeI2c_MarkIoError(void)
{
    if (g_i2c_last_error == M031_BRIDGE_I2C_ERROR_NONE)
    {
        g_i2c_last_error = M031_BRIDGE_I2C_ERROR_IO;
    }
}

static void BridgeI2c_MarkTimeout(void)
{
    g_i2c_last_error = M031_BRIDGE_I2C_ERROR_TIMEOUT;
}
...
static void BridgeI2c_SlavePushRx(uint8_t port, uint8_t data)
{
    ...
    if (index < M031_BRIDGE_I2C_SLAVE_BUF_SIZE)
    {
...
static uint8_t BridgeI2c_IsValidPair(uint8_t port, uint8_t sda_pin, uint8_t scl_pin)
{
    if (port == 0u)
    {
        if ((sda_pin == M031_PIN_B(4u)) && (scl_pin == M031_PIN_B(5u))) { return 1u; }
        if ((sda_pin == M031_PIN_F(2u)) && (scl_pin == M031_PIN_F(3u))) { return 1u; }
        if ((sda_pin == M031_PIN_A(4u)) && (scl_pin == M031_PIN_A(5u))) { return 1u; }
        if ((sda_pin == M031_PIN_C(0u)) && (scl_pin == M031_PIN_C(1u))) { return 1u; }
    }
    else if (port == 1u)
    {
        if ((sda_pin == M031_PIN_B(2u)) && (scl_pin == M031_PIN_B(3u))) { return 1u; }
        if ((sda_pin == M031_PIN_B(0u)) && (scl_pin == M031_PIN_B(1u))) { return 1u; }
        if ((sda_pin == M031_PIN_A(6u)) && (scl_pin == M031_PIN_A(7u))) { return 1u; }
        if ((sda_pin == M031_PIN_A(2u)) && (scl_pin == M031_PIN_A(3u))) { return 1u; }
        if ((sda_pin == M031_PIN_F(1u)) && (scl_pin == M031_PIN_F(0u))) { return 1u; }
        if ((sda_pin == M031_PIN_C(4u)) && (scl_pin == M031_PIN_C(5u))) { return 1u; }
        if ((sda_pin == M031_PIN_B(10u)) && (scl_pin == M031_PIN_B(11u))) { return 1u; }
    }
    return 0u;
}
...
static uint8_t BridgeI2c_ApplyMux(uint8_t port, uint8_t sda_pin, uint8_t scl_pin)
{
    ...
    if (port == 0u)
    {
        if ((sda_pin == M031_PIN_B(4u)) && (scl_pin == M031_PIN_B(5u)))
        {
            SYS->GPB_MFPL = (SYS->GPB_MFPL & ~(SYS_GPB_MFPL_PB4MFP_Msk | SYS_GPB_MFPL_PB5MFP_Msk)) |
                            (SYS_GPB_MFPL_PB4MFP_I2C0_SDA | SYS_GPB_MFPL_PB5MFP_I2C0_SCL);
        }
        else if ((sda_pin == M031_PIN_F(2u)) && (scl_pin == M031_PIN_F(3u)))
        {
        ...
        else if ((sda_pin == M031_PIN_A(4u)) && (scl_pin == M031_PIN_A(5u)))
        {
        ...
        else if ((sda_pin == M031_PIN_C(0u)) && (scl_pin == M031_PIN_C(1u)))
        {
    ...
    {
        if ((sda_pin == M031_PIN_B(2u)) && (scl_pin == M031_PIN_B(3u)))
        {
        ...
        else if ((sda_pin == M031_PIN_B(0u)) && (scl_pin == M031_PIN_B(1u)))
        {
        ...
        else if ((sda_pin == M031_PIN_A(6u)) && (scl_pin == M031_PIN_A(7u)))
        {
        ...
        else if ((sda_pin == M031_PIN_A(2u)) && (scl_pin == M031_PIN_A(3u)))
        {
        ...
        else if ((sda_pin == M031_PIN_F(1u)) && (scl_pin == M031_PIN_F(0u)))
        {
        ...
        else if ((sda_pin == M031_PIN_C(4u)) && (scl_pin == M031_PIN_C(5u)))
        {
        ...
        else if ((sda_pin == M031_PIN_B(10u)) && (scl_pin == M031_PIN_B(11u)))
        {
...
static uint8_t BridgeI2c_SmbusQuickReadBitBang(uint8_t port, uint8_t addr7, uint8_t *ack)
{
    ...
    if ((port >= M031_BRIDGE_I2C_PORT_COUNT) || (addr7 > 0x7Fu) ||
        (ack == 0) ||
        (g_i2c_state[port].initialized == 0u) ||
        (g_i2c_state[port].role != M031_BRIDGE_I2C_ROLE_MASTER))
    {
        return 0u;
    }
...
uint8_t M031BridgeI2c_IsMasterReady(uint8_t port)
{
    if (port >= M031_BRIDGE_I2C_PORT_COUNT)
    {
        return 0u;
    ...
    return ((g_i2c_state[port].initialized != 0u) &&
            (g_i2c_state[port].role == M031_BRIDGE_I2C_ROLE_MASTER)) ? 1u : 0u;
}

uint8_t M031BridgeI2c_IsSlaveReady(uint8_t port)
{
    if (port >= M031_BRIDGE_I2C_PORT_COUNT)
    {
        return 0u;
    ...
    return ((g_i2c_state[port].initialized != 0u) &&
            (g_i2c_state[port].role == M031_BRIDGE_I2C_ROLE_SLAVE)) ? 1u : 0u;
}

uint8_t M031BridgeI2c_LastError(void)
{
    return g_i2c_last_error;
}

uint8_t M031BridgeI2c_InitMaster(uint8_t port, uint8_t sda_pin, uint8_t scl_pin, uint32_t baudrate)
{
    I2C_T *i2c;
    uint8_t other_port;
    ...
    M031BridgeI2c_Deinit(other_port);
...
uint8_t M031BridgeI2c_InitSlave(uint8_t port, uint8_t sda_pin, uint8_t scl_pin, uint8_t addr7, uint32_t baudrate)
{
    I2C_T *i2c;
    uint8_t other_port;
    ...
    g_i2c_state[port].initialized = 1u;
    g_i2c_state[port].role = M031_BRIDGE_I2C_ROLE_SLAVE;
    g_i2c_state[port].sda_pin = sda_pin;
    g_i2c_state[port].scl_pin = scl_pin;
...
void M031BridgeI2c_Deinit(uint8_t port)
{
    I2C_T *i2c;
    uint8_t sda_pin;
    uint8_t scl_pin;
    ...
    sda_pin = g_i2c_state[port].sda_pin;
    scl_pin = g_i2c_state[port].scl_pin;
    was_slave = (g_i2c_state[port].role == M031_BRIDGE_I2C_ROLE_SLAVE) ? 1u : 0u;
...
uint8_t M031BridgeI2c_MasterWriteEx(uint8_t port, uint8_t addr7, const uint8_t *data, uint16_t len,
                                    uint16_t *written, uint8_t allow_final_data_nack)
{
    I2C_T *i2c;
    uint8_t xfering;
    uint8_t err;
    ...
    if ((port >= M031_BRIDGE_I2C_PORT_COUNT) || (addr7 > 0x7Fu) ||
        (M031BridgeI2c_IsMasterReady(port) == 0u) || ((data == 0) && (len != 0u)))
    {
        return 0u;
    }
    if (len == 0u)
    ...
    while ((xfering != 0u) && (err == 0u))
    {
        ...
        switch (status)
        {
            ...
            case 0x30u:
                if ((allow_final_data_nack != 0u) && (tx_len == len))
                {
                    ctrl = I2C_CTL_STO_SI;
                    xfering = 0u;
                }
...
uint8_t M031BridgeI2c_MasterWrite(uint8_t port, uint8_t addr7, const uint8_t *data, uint16_t len, uint16_t *written)
{
    return M031BridgeI2c_MasterWriteEx(port, addr7, data, len, written, 0u);
}

uint8_t M031BridgeI2c_MasterRead(uint8_t port, uint8_t addr7, uint8_t *out, uint16_t len, uint16_t *read_len)
{
    I2C_T *i2c;
    uint8_t xfering;
    uint8_t err;
    ...
    if ((port >= M031_BRIDGE_I2C_PORT_COUNT) || (addr7 > 0x7Fu) ||
        (M031BridgeI2c_IsMasterReady(port) == 0u) || ((out == 0) && (len != 0u)))
    {
        return 0u;
    }
    if (len == 0u)
...
uint8_t M031BridgeI2c_MasterWriteRead(uint8_t port, uint8_t addr7, const uint8_t *tx, uint16_t tx_len,
                                      uint8_t *rx, uint16_t rx_len, uint16_t *read_len, uint8_t repeated_start)
{
    ...
    if ((port >= M031_BRIDGE_I2C_PORT_COUNT) || (addr7 > 0x7Fu) ||
        (M031BridgeI2c_IsMasterReady(port) == 0u) ||
        ((tx == 0) && (tx_len != 0u)) ||
        ((rx == 0) && (rx_len != 0u)))
    {
        return 0u;
    ...
    if (rx_len == 0u)
    {
        return M031BridgeI2c_MasterWrite(port, addr7, tx, tx_len, &written);
    }
    if (tx_len == 0u)
    {
        return M031BridgeI2c_MasterRead(port, addr7, rx, rx_len, read_len);
    }
    if (repeated_start == 0u)
    {
        if (M031BridgeI2c_MasterWrite(port, addr7, tx, tx_len, &written) == 0u)
        {
            return 0u;
        }
        return M031BridgeI2c_MasterRead(port, addr7, rx, rx_len, read_len);
...
uint8_t M031BridgeI2c_PmbusBlockRead(uint8_t port, uint8_t addr7, const uint8_t *tx, uint16_t tx_len,
                                     uint8_t expect_pec, uint8_t max_block_len, uint8_t *out, uint16_t *out_len)
{
    ...
    if ((port >= M031_BRIDGE_I2C_PORT_COUNT) || (addr7 > 0x7Fu) ||
        (M031BridgeI2c_IsMasterReady(port) == 0u) || (tx == 0) ||
...
uint8_t M031BridgeI2c_GroupWrite(uint8_t port, const uint8_t *segment_blob, uint16_t blob_len,
                                 uint8_t segment_count, uint8_t *completed_segments)
{
    ...
    if ((port >= M031_BRIDGE_I2C_PORT_COUNT) || (segment_blob == 0) ||
        (segment_count == 0u) || (M031BridgeI2c_IsMasterReady(port) == 0u) ||
...
uint8_t M031BridgeI2c_BusStatus(uint8_t port, uint8_t recover_if_needed,
...
uint8_t M031BridgeI2c_SmbusQuick(uint8_t port, uint8_t addr7, uint8_t read_bit, uint8_t *ack)
{
    I2C_T *i2c;
    uint8_t xfering;
    uint8_t err;
    ...
    if ((port >= M031_BRIDGE_I2C_PORT_COUNT) || (addr7 > 0x7Fu) ||
        (M031BridgeI2c_IsMasterReady(port) == 0u) || (ack == 0))
    {
        return 0u;
    }
    if (read_bit != 0u)
...
uint8_t M031BridgeI2c_SlaveSetTx(uint8_t port, const uint8_t *data, uint16_t len, uint16_t *written)
{
    uint16_t index;
    IRQn_Type irq;
    ...
    if ((port >= M031_BRIDGE_I2C_PORT_COUNT) ||
        (M031BridgeI2c_IsSlaveReady(port) == 0u) ||
        ((data == 0) && (len != 0u)))
    {
        return 0u;
    }
    if (len > M031_BRIDGE_I2C_SLAVE_BUF_SIZE)
    {
        len = M031_BRIDGE_I2C_SLAVE_BUF_SIZE;
    }
...
uint8_t M031BridgeI2c_SlaveGetRx(uint8_t port, uint8_t *out, uint16_t max_len, uint16_t *read_len)
{
    uint16_t index;
    uint16_t count;
    uint16_t remain;
...
void M031BridgeI2c_IrqHandler(uint8_t port)
{
    I2C_T *i2c;
    uint32_t status;
    uint8_t ctrl;
...
{
    M031BridgeI2c_IrqHandler(0u);
}

void I2C1_IRQHandler(void)
{
    M031BridgeI2c_IrqHandler(1u);
}
